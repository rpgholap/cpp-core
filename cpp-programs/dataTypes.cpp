...
/*
    ...
    2. C++ has several built-in data types, including:
       - int: for integers (e.g., -1, 0, 21)      -----------------------------------> size: 4 bytes
       - float: for floating-point numbers (e.g., 1.21, 0.0, -3.14)  ------------------> size: 4 bytes
       - char: for single characters (e.g., 'a', 'b', 'c')           ------------------> size: 1 byte
       - string: for sequences of characters (e.g., "hello", "world") ------------------> size: varies
       - bool: for boolean values (true or false)               ------------------> size: 1 byte
       - double: for double-precision floating-point numbers (e.g., 1.23456789, 0.00001)       -----> size: 8 bytes
